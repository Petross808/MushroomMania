...
namespace State
{
    ...
    public abstract class ConditionBase : ScriptableGameObject
    {
        ...
        private EvaluateStrategy _evaluateStrategy = EvaluateStrategy.EvaluateUntilMet;
        ...
        private PriorityLevel _priorityLevel = PriorityLevel.Lowest; // Default to lowest priority
        ...
        private GameEvent _onConditionMet;
        ...
        private float _timeMet = -1f; // -1 indicates the condition hasn't been met yet

        protected GameEvent OnConditionMet => _onConditionMet;
        public bool IsMet { get => _isMet; protected set => _isMet = value; }
        public float TimeMet { get => _timeMet; protected set => _timeMet = value; }
        public PriorityLevel PriorityLevel { get => _priorityLevel; protected set => _priorityLevel = value; }
